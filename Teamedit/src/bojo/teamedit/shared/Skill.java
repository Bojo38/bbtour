...
public class Skill implements Serializable{
	...
	public static final Skill SureHands=new Skill("Dextérité",SkillType.GeneralSkill);
	public static final Skill Kick=new Skill("Frappe Précise",SkillType.GeneralSkill);
	public static final Skill Frenzy=new Skill("Frénésie",SkillType.GeneralSkill);
	public static final Skill Dauntless=new Skill("Intrépidité",SkillType.GeneralSkill);
	...
	public static final Skill SideStep=new Skill("Glissade contrôlée",SkillType.AgilitySkill);
	public static final Skill DivingCatch=new Skill("Plongeon",SkillType.AgilitySkill);
	public static final Skill Catch=new Skill("Réception",SkillType.AgilitySkill);
	...
	public static final Skill SafeThrow=new Skill("Lancer Précis",SkillType.PassSkill);
	...
	public static final Skill Accurate=new Skill("Précision",SkillType.PassSkill);
	
	public static final Skill MultipleBlock=new Skill("Blocage Multiple",SkillType.StrengthSkill);
	public static final Skill MightyBlow=new Skill("Châtaigne",SkillType.StrengthSkill);
	public static final Skill StrongArm=new Skill("Costaud",SkillType.StrengthSkill);
	public static final Skill ThickSkull=new Skill("Crâne Epais",SkillType.StrengthSkill);
	...
	public static final Skill StandFirm=new Skill("Stabilité",SkillType.StrengthSkill);
	
	public static final Skill ExtraArm=new Skill("Bras Supplémentaires",SkillType.Mutation);
	public static final Skill Horns=new Skill("Cornes",SkillType.Mutation);
	public static final Skill TwoHeads=new Skill("Deux Têtes",SkillType.Mutation);
	public static final Skill BigHand=new Skill("Main Démesurée",SkillType.Mutation);
	public static final Skill Claws=new Skill("Pince / Griffes",SkillType.Mutation);
	public static final Skill DisturbingPresence=new Skill("Présence Perturbante",SkillType.Mutation);
	public static final Skill PrehensileTail=new Skill("Queue Préhensile",SkillType.Mutation);
	public static final Skill FoulAppearance=new Skill("Répulsion",SkillType.Mutation);
	public static final Skill Tentacles=new Skill("Tentacules",SkillType.Mutation);
	public static final Skill VeryLongLegs=new Skill("Très Longues Jambes",SkillType.Mutation);
	
	public static final Skill WildAnimal=new Skill("Animal Sauvage",SkillType.ExtraoridnarySkill);
	public static final Skill Animosity=new Skill("Animosité",SkillType.ExtraoridnarySkill);
	public static final Skill SecreatWeapon=new Skill("Arme Secrète",SkillType.ExtraoridnarySkill);
	...
	public static final Skill BallAndChain=new Skill("Chaîne & Boulet",SkillType.ExtraoridnarySkill);
	public static final Skill Decay=new Skill("Décomposition",SkillType.ExtraoridnarySkill);
	public static final Skill ReallyStupid=new Skill("Gros Débile",SkillType.ExtraoridnarySkill);
	...
	public static final Skill ThrowTeammate=new Skill("Lancer un Coéquipier",SkillType.ExtraoridnarySkill);
	...
	public static final Skill Regeneration=new Skill("Régénération",SkillType.ExtraoridnarySkill);
	...
	public static final Skill AlwaysHungry=new Skill("Toujours Affamé",SkillType.ExtraoridnarySkill);
	public static final Skill Chainsaw=new Skill("Tronçonneuse",SkillType.ExtraoridnarySkill);
